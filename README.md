...
2. Алгоритм выполненный по методу обучения RL. Финальная вероятность выбора лучшего претендента на роль жениха на уровне 33%. Результат сравним с математическим алгоритмом.
